...
modules = Graphics.UI.Clutter.Types Graphics.UI.Clutter.General Graphics.UI.Clutter.Color Graphics.UI.Clutter.Actor Graphics.UI.Clutter.Rectangle Graphics.UI.Clutter.Stage Graphics.UI.Clutter
GHC = /usr/bin/ghc
GHC_VERSION = 6.10.4
VANILLA_WAY = YES
WAYS = 
...
GHC_OPTS = -package-name clutter-0.0.1 -hide-all-packages -no-user-package-conf -i -idist/build -i. -i./Graphics -i./Graphics/UI -i./Graphics/UI/Clutter -idist/build/autogen -Idist/build/autogen -Idist/build -I/usr/include/clutter-1.0/ -I/usr/include/glib-2.0 -I/usr/include/glib-2.0/glib -I/usr/lib/glib-2.0/include -I/usr/include/pango-1.0/ -I/usr/include/cairo -I/usr/local/include -I/usr/include/gtk-2.0 -I/usr/lib/gtk-2.0/include -I/usr/include/atk-1.0 -I/usr/include/pango-1.0 -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng12 -I/usr/include/clutter-1.0 -optP-DDEBUG -optP-include -optPdist/build/autogen/cabal_macros.h -\#include "clutter/clutter.h" -odir dist/build -hidir dist/build -stubdir dist/build -package base-4.1.0.0 -package c2hs-0.16.0 -package glib-0.10.1 -package gtk-0.10.1 -package haskell98-1.0.1.0 -O -XCPP -XFlexibleInstances -XForeignFunctionInterface -XTypeSynonymInstances
MAKEFILE = Makefile
C_SRCS = 
GHC_CC_OPTS = -I/usr/include/clutter-1.0/ -I/usr/include/glib-2.0 -I/usr/include/glib-2.0/glib -I/usr/lib/glib-2.0/include -I/usr/include/pango-1.0/ -I/usr/include/cairo -I/usr/local/include -I/usr/include/gtk-2.0 -I/usr/lib/gtk-2.0/include -I/usr/include/atk-1.0 -I/usr/include/pango-1.0 -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng12 -I/usr/include/clutter-1.0 -package base-4.1.0.0 -package c2hs-0.16.0 -package glib-0.10.1 -package gtk-0.10.1 -package haskell98-1.0.1.0 -optc-DDEBUG -optc-pthread -optc-O2 -odir dist/build
GHCI_LIB = dist/build/HSclutter-0.0.1.o
soext = so
LIB_LD_OPTS = -package-name clutter-0.0.1 -package base-4.1.0.0 -package c2hs-0.16.0 -package glib-0.10.1 -package gtk-0.10.1 -package haskell98-1.0.1.0 -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lgio-2.0 -lpangoft2-1.0 -lfreetype -lfontconfig -lclutter-glx-1.0 -lpangocairo-1.0 -lgthread-2.0 -lrt -lgdk_pixbuf-2.0 -lGL -lX11 -lXext -lXdamage -lXcomposite -lpango-1.0 -lcairo -lgobject-2.0 -lgmodule-2.0 -lglib-2.0 -lXfixes -L/usr/local/lib
AR = /usr/bin/ar
LD = /usr/bin/ld -x
